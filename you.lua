...
-- Pos FINALATIN asli (ambil dari script FINALATIN)
local path = {
    Vector3.new(10,50,20), -- pos 26
    Vector3.new(100,200,150) -- puncak
}
...
-- Auto Summit (path FINALATIN asli)
autoSummitButton.MouseButton1Click:Connect(function()
    ...
    for i, pos in ipairs(path) do
        ...
        task.wait(0.5) -- tunggu checkpoint / stabil
    end
...
runService.RenderStepped:Connect(function(delta)
    if flying then
        ...
        bv.Velocity = direction * 50 -- bisa ubah kecepatan
    else
        bv.Velocity = Vector3.new(0,0,0)
    end
end)
