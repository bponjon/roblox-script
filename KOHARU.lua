-- MountKoharu AutoSummit (Basecamp + 19 Checkpoints + Puncak)
...
-- === POSISI CHECKPOINT MOUNT KOHARU ===
local checkpoints = {
...
local function createGui()
    ...
    -- buat tombol teleport setiap checkpoint
    local i = 0
    for name, pos in pairs(checkpoints) do
        local btn = Instance.new("TextButton", scroll)
        btn.Size = UDim2.new(1, -4, 0, 30)
        btn.Position = UDim2.new(0, 2, 0, i * 32)
    ...
    autoBtn.MouseButton1Click:Connect(function()
        ...
        task.spawn(function()
            while autoSummitActive do
                for _, pos in pairs(checkpoints) do
...
createGui()
print("MountKoharu AutoSummit loaded. GUI active.")
