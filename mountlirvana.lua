...
local checkpoints = {
    ...
    {name="Checkpoint 6", pos=Vector3.new(624.076, 624.700, -1026.100)},
    {name="Checkpoint 7", pos=Vector3.new(972.346, 672.700, -951.703)},
    {name="Checkpoint 8", pos=Vector3.new(1166.363, 692.700, -664.891)},
    {name="Checkpoint 9", pos=Vector3.new(1219.765, 716.700, -334.745)},
    {name="Checkpoint 10", pos=Vector3.new(769.958, 1000.500, 216.734)}
}
