-- ===== Yahyuk Teleport vFinal+DelayAdjust =====
local player = game.Players.LocalPlayer

-- ===== Checkpoints + Delay =====
local checkpoints = {
    {name="Basecamp", pos=Vector3.new(-953.328, 171.144, 881.428), delay=15},
    {name="Checkpoint 1", pos=Vector3.new(-417.413, 248.723, 786.200), delay=15},
    {name="Checkpoint 2", pos=Vector3.new(-328.026, 388.645, 528.597), delay=15},
    {name="Checkpoint 3", pos=Vector3.new(293.615, 431.350, 494.099), delay=15},
    {name="Checkpoint 4", pos=Vector3.new(324.074, 487.911, 363.436), delay=25},
    {name="Checkpoint 5", pos=Vector3.new(232.235, 315.224, -143.314), delay=25},
    {name="Puncak", pos=CFrame.new(-614.627, 905.156, -549.331, -0.951406, 0, 0.307939, 0, 1, 0, -0.307939, 0, -0.951406), delay=0}
}
