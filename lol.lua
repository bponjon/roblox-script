...
-- Load FINALATIN asli
loadstring(game:HttpGet("https://raw.githubusercontent.com/zevilents/mount-atin/refs/heads/main/FINALATIN"))()

-- Wait sebentar biar FINALATIN load sempurna
task.wait(2)
...
-- Fly toggle (hanya aktif jika FINALATIN tidak sedang Auto Summit)
flyButton.MouseButton1Click:Connect(function()
    if not _G.AutoSummitActive then -- asumsi FINALATIN set variabel global AutoSummitActive saat jalan
        flying = not flying
    end
end)
